...
export function jsonAssertSpell(str: string): Spell[] | undefined {
    try {
        ...
        }, _errorFactory)) && ("boolean" === typeof input.ExpectTargetCursor || __typia_transform__assertGuard._assertGuard(_exceptionable, {
            method: "assertParse",
            path: _path + ".ExpectTargetCursor",
            expected: "boolean",
            value: input.ExpectTargetCursor
