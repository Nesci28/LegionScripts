...
class Caster:
    ...
    def _checkIfGearBroken(self):
        if Util.checkIfGearBroken():
            ...
            API.Stop()
#=========== End of _Skills\_Caster.py ============#

#=========== Start of _Skills\Magery.py ============#
...
class Magery(Caster):
    ...
    def _target(self):
        ...
        if targetType == "Harmful":
            ...
            API.TargetSelf()
#=========== End of _Skills\Magery.py ============#

#=========== Start of _Skills\Mysticism.py ============#
...
class Mysticism(Caster):
    ...
    def _target(self):
        API.TargetSelf()
#=========== End of _Skills\Mysticism.py ============#

#=========== Start of _Skills\Necromancy.py ============#
...
class Necromancy(Caster):
    ...
    def _target(self):
        API.TargetSelf()
#=========== End of _Skills\Necromancy.py ============#

#=========== Start of _Skills\Chivalry.py ============#
...
class Chivalry(Caster):
    ...
    def _target(self):
        API.TargetSelf()
#=========== End of _Skills\Chivalry.py ============#

#=========== Start of _Skills\Spellweaving.py ============#
...
class Spellweaving(Caster):
    ...
    def _target(self):
        API.TargetSelf()
#=========== End of _Skills\Spellweaving.py ============#

#=========== Start of _Skills\Bushido.py ============#
...
class Bushido(Caster):
    ...
    def _target(self):
        API.TargetSelf()
#=========== End of _Skills\Bushido.py ============#

#=========== Start of _Skills\EvaluatingIntelligence.py ============#
...
class EvaluatingIntelligence(Caster):
    ...
    def _target(self):
        pass
#=========== End of _Skills\EvaluatingIntelligence.py ============#

#=========== Start of _Skills\SpiritSpeak.py ============#
...
class SpiritSpeak(Caster):
    ...
    def _target(self):
        pass
#=========== End of _Skills\SpiritSpeak.py ============#

#=========== Start of _Skills\Meditation.py ============#
...
#=========== Start of _Skills\Musicianship.py ============#
...
#=========== End of _Skills\Musicianship.py ============#
...
#=========== End of _Skills\AnimalLore.py ============#

#=========== Start of .\Train\skill-trainer.py ============#
