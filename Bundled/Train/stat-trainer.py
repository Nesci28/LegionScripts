...
class ArmsLore:
    ...
    def train(self):
        ...
        while value < self.skillCap:
            self.trainOnce()
#=========== End of _Skills\ArmsLore.py ============#

#=========== Start of _Skills\ItemIdentification.py ============#
...
class ItemIdentification:
    ...
    def train(self):
        ...
        while value < self.skillCap:
            self.trainOnce()
#=========== End of _Skills\ItemIdentification.py ============#

#=========== Start of .\Train\stat-trainer.py ============#
